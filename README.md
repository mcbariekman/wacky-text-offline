...
A [web application](https://wacky-text-offline.herokuapp.com/){:target="_blank"} that provides a text editor with features such as bundling JavaScript files, utilizing next-gen JavaScript, storing content using IndexedDB, and enabling offline functionality with service workers.
